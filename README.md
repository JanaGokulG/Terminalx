...
## ✨ Features
• Full theme customization (colors, fonts, backgrounds)
• Real shell integration via pseudo-terminal (pty)
• Cross-platform compatibility (Windows, macOS, Linux)
• Personalized command history and aliases
• Responsive GUI with native system integration
